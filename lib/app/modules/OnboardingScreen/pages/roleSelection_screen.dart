          ...
          children: [
            Row(
              children: [
                IconButton(
                  ...
                  icon: SvgPicture.asset(ImagesIconApp.iconbackleft)
                ),
                SizedBox(
                  width: 10,
                ),
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Image.asset(ImagesIconApp.mane_work)))
          ],
        ),
      )
    );
...
//                                           ),
//                                           child: controller.isSelect.value == index
//                                                   ? Container(
//                                                     decoration: BoxDecoration(
...
//                         backgroundColor: controller.isSelect.value > (-1)
...
//                         "Next Step".tr,
//                         style: GoogleFonts.robotoCondensed(
//                           color: controller.isSelect.value > (-1)
